    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        NewsTopicsMapper,
        {
          ...
          useValue: {
            transaction: async (
              work: (manager: EntityManager) => Promise<NewsTopicDto | null>,
        ...
        },
        {
          ...
          useValue: {
            findByTelegramId: findUser,
            getOrCreateByTelegramId: createUser,
          },
        },
        { provide: NewsTopicsService, useValue: {} },
        {
          provide: NewsSubscriptionRepository,
          useValue: { findForUpdate: findSubscription, save: saveSubscription },
        },
      ],
    }).compile();
    try {
      const service: NewsSubscriptionService = module.get(
        NewsSubscriptionService,
      );
      const result: NewsTopicDto | null = await service.unsubscribe('12345', 1);
